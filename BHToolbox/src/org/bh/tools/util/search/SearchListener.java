 ...
 * @version 1.0.0
 *		- 2015-04-14 (1.0.0) - Kyli created SearchListener
 * @since 2015-04-14
 */
public interface SearchListener<ArgType, ResultType>
{
    /**
     * Indicates that a search has begun with the given arguments. You may return {@code false} if you think the
     * search should not be performed, and the search engine can opt to stop due to that.
     * @param args The arguments that will be used. Modifications of this array may be ignored.
     ...
     */
    public void searchFailed(ResultType[] anyResults);
}
