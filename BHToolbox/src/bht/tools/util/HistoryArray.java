 ...
 * As you may guess, at the heart of this class is the <tt>ArrayPP</tt> class, to make management as efficient as possible.
...
public class HistoryArray<T> extends ArrayPP<T>
{
  ...
  {
    NavigationEvent evt = new NavigationEvent(this, here, length() + items.length - 2, getCurrent(), items[items.length - 1], NavigationEvent.STATE_SKIPPING);
  ...
  {
    NavigationEvent evt = new NavigationEvent(this, here, here + 1, getCurrent(), getVirtualNext(), NavigationEvent.STATE_GOING_FORWARD);
  ...
  {
    NavigationEvent evt = new NavigationEvent(this, here, here - 1, getCurrent(), getVirtualBack(), NavigationEvent.STATE_GOING_BACKWARD);
  ...
  {
    NavigationEvent evt = new NavigationEvent(this, here, loc, getCurrent(), get(loc), NavigationEvent.STATE_SKIPPING);
