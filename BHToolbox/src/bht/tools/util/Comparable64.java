...
/**
 * Comparable64, made for BHToolbox, is made by and copyrighted to Blue Husky Programming, ©2012. License is default.<hr/>
 ...
 * @see Comparable
 */
public interface Comparable64<T> extends Comparable<T> //NOTE: Must be compiled in UTF-8
{
    /**
     ...
     */
  public abstract long compareTo64(T otherComparable);
}
