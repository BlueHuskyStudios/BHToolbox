 ...
 * Acts like a lightweight version of {@link javax.swing.Timer}. This class performs a specified action until told to stop, with
 * a specified delay between repetitions. This class takes advantage of separate threads, so make use of synchronized methods
...
public class BHTimer
{
	...
	/**
	 * Creates a new BHTimer that will perform the given action repeatedly approximately the given number of times per second
	 *
...
//    timer.notify();
	...
	/**
	 * Sets the delay in milliseconds between action firings. This value must be higher than or equal to 0. If it is less than
	...
	/**
	 * Sets the priority of the timer thread. Any value between {@link #PRIORITY_VERY_HIGH} and {@link #PRIORITY_VERY_LOW},
