/*
 *                   BLUE HUSKY LICENSE 1 - PUBLIC SHARE - OPUS 1
 * 
 * 0: LAYMAN'S TERMS
 ...
 *    b. If you do include someone else's stuff, you can't claim that you made it
 ...
 *    This Product is copyright Blue Husky Programming (c) 2015 BH-1-PS
 * 
 * 2: DEFINITIONS
 *  - "License": this text
 ...
 * intellectual property which falls under ยง 5.1 of this License is considered
 * fair use as described in ยง 5.4 of this License.
 * 
 ...
 *    c. 17 USC ยง 107 - Limitations on exclusive rights: Fair use
 *  5. In cases where all of the documents listed under ยง 5.4 of this
...
/**
 * Haystack, made for BH Font Manager, is copyright Blue Husky Programming ©2015 GPLv3 <hr/>
 * 
 * @param <T> The type of item to be searched
 * 
 * @author Kyli of Blue Husky Programming
 * @version 1.0.0
		- 2015-02-04 (1.0.0) - Kyli created Haystack
 * @since 2015-02-04
 */
public interface Haystack<T extends Needle>
{
	public ArrayPP<T> searchFor(T item);
}
